...
function createImgs() {
  ...
  if (!imgs || !imgs.length) {
    imgs = [
      ...
      createImg('img/24.jpg', ['anime', 'one piece']),
      ...
      createImg('img/19.jpg', ['anime', 'girl']),
      createImg('img/23.jpg', ['anime', 'dbz']),
    ]
  }
  gImgs = imgs
  _saveImgsToStorage()
